...
import '../presentation/widgets/gen_ui/stitch_design_preview_widget.dart';
import '../presentation/widgets/gen_ui/stitch_design_carousel_widget.dart';
import '../presentation/widgets/gen_ui/stitch_code_export_widget.dart';
...
class _AiAssistantOverlayState extends ConsumerState<AiAssistantOverlay> {
  ...
  Widget _buildGenUI(Map<String, dynamic> payload) {
    ...
    switch (type) {
      ...
      case 'timeline':
        // Timeline is a variant of trend_report with milestones
        return TrendReportWidget(data: payload);
      case 'gen_ui_layout':
        return _buildCompositeLayout(payload);
      default:
  ...
  /// Builds a composite layout that combines multiple GenUI components.
  /// Expected payload shape:
  /// {
  ///   "type": "gen_ui_layout",
  ///   "layout": "grid" | "stacked" | "tabs" | "split",
  ///   "title": "Dashboard Title",
  ///   "components": [
  ///     { "type": "budget_chart", ...data },
  ///     { "type": "kanban_board", ...data },
  ///   ]
  /// }
  Widget _buildCompositeLayout(Map<String, dynamic> payload) {
