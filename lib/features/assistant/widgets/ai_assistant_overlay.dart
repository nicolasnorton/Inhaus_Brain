    ...
    switch (_toolMode) {
      ...
      case ToolMode.code: // Code uses text models primarily
        menuItems = [
          ...
          _buildGroupHeader('FRONTIER (3.x)'),
          _buildModelMenuItem(ref, AIModelConfig.geminiFlash3, FontAwesomeIcons.boltLightning),
          _buildModelMenuItem(ref, AIModelConfig.geminiPro3, FontAwesomeIcons.google),
          const PopupMenuDivider(),
