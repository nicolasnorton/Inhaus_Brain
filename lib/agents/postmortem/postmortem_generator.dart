...
class PostmortemAgent extends BaseAgent {
  @override
  String get name => "Postmortem Agent";
  
  @override
  MessageSender get type => MessageSender.postmortemAgent;

  @override
  String get systemPromptKey => "postmortem.md"; 
  ...
  Future<String> execute({
    ...
    if (ref != null) {
      ...
      final basePrompt = await promptService.getPostmortemPrompt();
      prompt = systemPrompt ?? basePrompt;
    }

    prompt ??= "You are the Postmortem Agent. Generate blameless reports.";

    return _postmortemExecute(
      agentName: name,
      systemPrompt: prompt,
...
Future<String> _postmortemExecute({
