...
OPTIONAL_KEYS=("VEO_API_KEY" "OPENAI_API_KEY" "ANTHROPIC_API_KEY" "XAI_API_KEY" "IMAGEN_API_KEY" "ELEVEN_LABS_API_KEY" "DIFY_API_KEY" "RUNWAY_API_KEY" "PINECONE_API_KEY")
